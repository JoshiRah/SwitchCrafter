...
def SaveUserInput():
    ...
    tk.Label(popUp, text=f'GUEST-VLAN:').grid(row=15,column=0)
    tk.Label(popUp, text=instance.vidIO).grid(row=15,column=1)
    tk.Label(popUp, text=f'GUEST-Name:').grid(row=15,column=3)
    tk.Label(popUp, text=instance.nameIO).grid(row=15,column=5)
    tk.Label(popUp, text='').grid(row=16,column=0)
    tk.Label(popUp, text=f'Interface-VLAN:').grid(row=17,column=0)
    tk.Label(popUp, text=instance.vlan).grid(row=17,column=1)
    tk.Label(popUp, text='').grid(row=18,column=0)
    tk.Label(popUp, text=f'Interface-IP:').grid(row=19,column=0)
    tk.Label(popUp, text=instance.ip).grid(row=19,column=1)
    tk.Label(popUp, text=f'Subnetmask:').grid(row=19,column=3)
    tk.Label(popUp, text=instance.mask).grid(row=19,column=5)
    tk.Label(popUp, text=f'Default Gateway:').grid(row=19,column=7)
    tk.Label(popUp, text=instance.gw).grid(row=19,column=9)
    tk.Label(popUp, text='').grid(row=20,column=0)
    tk.Label(popUp, text=f'DNS-Server:').grid(row=21,column=0)
    tk.Label(popUp, text=instance.dns).grid(row=21,column=1)
    tk.Label(popUp, text=f'Domain name:').grid(row=21,column=3)
    tk.Label(popUp, text=instance.domain).grid(row=21,column=5)
    tk.Label(popUp, text='').grid(row=22,column=0)
    tk.Label(popUp, text=f'SNMP-Community:').grid(row=23,column=0)
    tk.Label(popUp, text=instance.comm).grid(row=23,column=1)
    tk.Label(popUp, text=f'SNMP-Contact:').grid(row=23,column=3)
    tk.Label(popUp, text=instance.cont).grid(row=23,column=5)
    tk.Label(popUp, text=f'SNMP-Location:').grid(row=23,column=7)
    tk.Label(popUp, text=instance.loc).grid(row=23,column=9)
    tk.Label(popUp, text='').grid(row=24,column=0)
    tk.Label(popUp, text=f'Remote-Logging:').grid(row=25,column=0)
    tk.Label(popUp, text=instance.rs).grid(row=25,column=1)
    tk.Label(popUp, text=f'NTP-Server:').grid(row=25,column=3)
    tk.Label(popUp, text=instance.ntp).grid(row=25,column=5)
    tk.Label(popUp, text='').grid(row=26,column=0)
    tk.Label(popUp, text='').grid(row=27,column=0)
